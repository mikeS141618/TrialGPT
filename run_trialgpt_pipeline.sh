...
# Set variables
CORPUS="mine" #"sigir" #"sigir_small" "sigir_mini"
MODEL="Llama-3.3-70B-Instruct" #"gpt-4o-mini" "gpt-4o" "Llama-3.2-3B-Instruct" "Llama-3.3-70B-Instruct"
QUANTIZE=true
...
OVER_WRITE=true #true #'true' false
